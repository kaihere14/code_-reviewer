...
const DetailOne = () => {
  return (
    <div  className="w-full flex px-8 md:px-15 mt-32">
      ...
      <div className="right  hidden md:flex flex-col items-end text-lg font-light justify-end leading-8 w-full text-[16px] text-gray-400">
        <div>
