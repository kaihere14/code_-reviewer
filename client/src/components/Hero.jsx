...
const Hero = () => {
  return (
    <div  className="flex mt-40 flex-col items-center justify-center relative z-10 overflow-hidden">
        <div className="text-9xl font-md">
          Ship cleaner <span className="italic font-serif">code</span> Faster.
        </div>
        <div className="mt-8 text-center text-lg w-2/3 font-light text-zinc-300">
          Catch bugs before they ship with AI-powered code reviews that
          understand your codebase.
        </div>
        <div className="mt-8 flex gap-5">
          <button className="bg-white cursor-pointer text-black px-8 py-3 rounded-full font-semibold hover:bg-zinc-100 transition-all shadow-lg">
            Start reviewing
          </button>
        ...
        <div className="landing-image mt-20 -mb-32 translate-y-6">
          <div className="relative">
            
            <div className="absolute inset-0 bg-white/5 blur-3xl rounded-3xl"></div>

           
            <div className="relative mx-auto h-105 w-225 overflow-hidden rounded-xl border border-white/10 shadow-2xl ring-1 ring-white/5">
  <img
    src="/landing.png"
